var decoder, pl, sQ, sl, dialog, co, cov, zo, zov, br, brv, tr, trv, sh, shv, gr, grv, si, sv;
...
(function (window) {
	...
	//    alert("total devices: " + deviceInfos.length);
	...
	//		alert("source kind:" + sourceInfo.kind + " source facing: " + sourceInfo.facing + " source label: " + sourceInfo.label);
